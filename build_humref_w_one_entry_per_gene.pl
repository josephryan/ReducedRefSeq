...
our $PROGRAM_NAME = 'build_humref_w_one_entry_per_gene.pl';
our $VERSION = 0.01;
...
B<build_humref_w_one_entry_per_gene.pl> - make FASTA file of RefSeq file including NCBI gene name in defline and only one isoform of that gene per gene
...
build_humref_w_one_entry_per_gene.pl --fasta=FASTA --gene2accession=GENE2ACCESSIONFILE [--help] [--version]
